...
export default function LecturasPage() {
  ...
  const validate = (): boolean => {
    ...
    if (!formData.fechaHoy) e.fechaHoy = "Ingresá la fecha de hoy";
                ...
                <Collapsible open={agreementOpen} onOpenChange={setAgreementOpen}>
                  ...
                  <CollapsibleContent>
                    <div className="pt-4 space-y-4 text-sm text-foreground/70 leading-relaxed">
                      ...
                      <p>
                        Si estás pensando realizar en conjunto una lectura con alguien más, por ejemplo tu pareja o alguien de tu núcleo familiar, o amigxs cercanxs, por favor indicámelo para poder observar en conjunto y de manera más ordenada cómo la energía de ambxs interactúan en el vínculo. Podría ser confuso para mí a la hora de abrir tus Registros, si no tengo con anticipación la información de que ambas personas en el mismo momento, están solicitándome una lectura de Registros Akáshicos para cada una.
                      </p>
                  ...
                  <div className="space-y-6">
                    ...
                    <div>
                      ...
                      <div className="space-y-4">
                        ...
                        {/* Fecha de hoy */}
                        <div className="space-y-1.5">
                          <Label htmlFor="fechaHoy" className="text-foreground/80 text-sm font-medium">
                            Fecha de hoy <span className="text-gold-400">*</span>
                          </Label>
                          <Input
                            id="fechaHoy"
                            type="date"
                            value={formData.fechaHoy}
                            onChange={(e) => updateField("fechaHoy", e.target.value)}
                            className={`bg-mystic-900/50 border-mystic-700/40 focus:border-gold-400/60 text-foreground [color-scheme:dark] ${errors.fechaHoy ? "border-red-400/60" : ""}`}
                          />
                          {errors.fechaHoy && <p className="text-red-400 text-xs">{errors.fechaHoy}</p>}
                        </div>
