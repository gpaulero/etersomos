...
export const defaultSiteContent: SiteContentItem[] = [
  ...
  { key: "courses.n1practica_price_ars", value: "45000", section: "courses", label: "N1 Práctica - Precio ARS", type: "number" },
  { key: "courses.n1practica_price_usd", value: "35", section: "courses", label: "N1 Práctica - Precio USD", type: "number" },
  { key: "courses.n1practica_badge", value: "Más Elegido", section: "courses", label: "N1 Práctica - Badge", type: "text" },
  { key: "courses.n2_price_ars", value: "60000", section: "courses", label: "N2 Completo - Precio ARS", type: "number" },
  { key: "courses.n2_price_usd", value: "50", section: "courses", label: "N2 Completo - Precio USD", type: "number" },
  { key: "courses.n2_badge", value: "", section: "courses", label: "N2 Completo - Badge", type: "text" },
  { key: "courses.ambos_price_ars", value: "85000", section: "courses", label: "Ambos Cursos - Precio ARS", type: "number" },
  { key: "courses.ambos_price_usd", value: "65", section: "courses", label: "Ambos Cursos - Precio USD", type: "number" },
